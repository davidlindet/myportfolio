...
<section class="single_project">
    <img src="img/projects/alchemyquest.jpg">
    ...
    <div id="modal-alchemyquest" class="modal">
        ...
        <p>
            ...
            <a class="zoombox preview zgallery1" title="Partie en cours" href="img/projects/alchemyquest/game.png"><img width="100" src="img/projects/alchemyquest/game.png"></a>
            <a class="zoombox preview zgallery1" title="Classement" href="img/projects/alchemyquest/hiscore.png"><img width="100" src="img/projects/alchemyquest/hiscore.png"></a>
        </p>
        ...
        <p>
            <label>Captures:</label>
            <a class="zoombox preview zgallery1" title="Game" href="img/projects/alchemyquest/game.png"><img width="100" src="img/projects/alchemyquest/game.png"></a>
            <a class="zoombox preview zgallery1" title="Ranking" href="img/projects/alchemyquest/hiscore.png"><img width="100" src="img/projects/alchemyquest/hiscore.png"></a>
        </p>
